...
def send_results_email(
    ...
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
      ...
      <p style="color: #444; line-height: 1.7;">
        Your personality analysis is complete. Based on your survey responses,
        your personality type is <strong style="color: #00e5b0;">{personality_type}</strong>.
      </p>

      <p style="color: #444; line-height: 1.7;">
        We've attached two files to this email:
      </p>

      <ul style="color: #444; line-height: 2;">
        <li><strong>Career Coaching Report (PDF)</strong> — your full personality analysis and top career matches</li>
        <li><strong>Infographic (PNG)</strong> — a visual summary you can save and share</li>
      </ul>
      ...
      <div style="background: #f8f9ff; border-left: 4px solid #5b8cff; padding: 16px 20px; margin: 24px 0; border-radius: 0 8px 8px 0;">
        <p style="color: #333; margin: 0; font-size: 14px; line-height: 1.7;">
          Take your time reviewing the results. The action steps in your report
          are a great starting point for your career journey.
        </p>
      </div>
